...
i=1;
sign_break = 0;
for omega=3*pi % unit is rad/s . Cam angular velocity
    a=0;
    b=0.01;
    c=1000*(2*pi)/omega;
    n=floor((c-a)/b + 1);
    P_aims=100*ones(n,1);
    sign_break = 0;
    for t1=97.8 % Range: 0~100, indicating the starting working time of the injector during the period T=100ms.
        for t2=70 % Range: 0~100, indicating the starting working time of the injector during the period T=100ms.
            k=1;
